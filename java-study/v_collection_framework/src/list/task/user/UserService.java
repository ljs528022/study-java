...
//	- 로그인
	public boolean login(String email, String password) {
		for (int i = 0; i < DBConnecter.users.size(); i++) {
			if (DBConnecter.users.get(i).getEmail().equals(email)) {
				if (DBConnecter.users.get(i).getPassword().equals(password)) {
					return true;
				}
			}
		}
...
//				DBConnecter.users.get(i).setPassword(user.getPassword());
			}
		}
	}
...
//	- 인증번호 전송
	public String sendEmail(String email) {
		...
		String fromEmail = "ljs528022@gmail.com";
		String fromUsername = "이정식";

		String toEmail = email;

		final String username = "ljs528022";
