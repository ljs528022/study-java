...
public class MemberVO {
   ...
   public void setMemberGender(String memberGender) {
      this.memberGender = MemberGender.getEnum(memberGender);
   }
   ...
   public void setMemberStatus(String memberStatus) {
      this.memberStatus = Status.getEnum(memberStatus);
   }
   ...
   public String toString() {
      return "MemberVO [id=" + id + ", memberEmail=" + memberEmail + ", memberPassword=" + memberPassword
            ...
            + ", memberStatus=" + memberStatus + ", createdDatetime=" + createdDatetime + ", updatedDatetime="
            + updatedDatetime + "]";
   }
